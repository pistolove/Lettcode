...
public class FileDescriptorProtoPOJO$$JProtoBufClass implements com.baidu.bjf.remoting.protobuf.Codec<com.baidu.bjf.remoting.protobuf.descriptor.FileDescriptorProtoPOJO> {
    ...
    public byte[] encode(com.baidu.bjf.remoting.protobuf.descriptor.FileDescriptorProtoPOJO t) throws IOException {
        ...
        if (!CodedConstant.isNull(t.dependencies)) {
            size += CodedConstant.computeListSize(3, f_3, FieldType.STRING, false, ProtobufProxy.OUTPUT_PATH.get());
        ...
        if (!CodedConstant.isNull(t.messageTypes)) {
            size += CodedConstant.computeListSize(4, f_4, FieldType.OBJECT, false, ProtobufProxy.OUTPUT_PATH.get());
        ...
        if (!CodedConstant.isNull(t.enumTypes)) {
            size += CodedConstant.computeListSize(5, f_5, FieldType.OBJECT, false, ProtobufProxy.OUTPUT_PATH.get());
        ...
        if (!CodedConstant.isNull(t.services)) {
            size += CodedConstant.computeListSize(6, f_6, FieldType.OBJECT, false, ProtobufProxy.OUTPUT_PATH.get());
        ...
        if (!CodedConstant.isNull(t.extensions)) {
            size += CodedConstant.computeListSize(7, f_7, FieldType.OBJECT, false, ProtobufProxy.OUTPUT_PATH.get());
        ...
        if (!CodedConstant.isNull(t.options)) {
            size += CodedConstant.computeSize(8, f_8, FieldType.OBJECT, false, ProtobufProxy.OUTPUT_PATH.get());
        ...
        if (!CodedConstant.isNull(t.sourceCodeInfo)) {
            size += CodedConstant.computeSize(9, f_9, FieldType.OBJECT, false, ProtobufProxy.OUTPUT_PATH.get());
        ...
        if (!CodedConstant.isNull(t.publicDependency)) {
            size += CodedConstant.computeListSize(10, f_10, FieldType.INT32, false, ProtobufProxy.OUTPUT_PATH.get());
        ...
        if (!CodedConstant.isNull(t.weakDependency)) {
            size += CodedConstant.computeListSize(11, f_11, FieldType.INT32, false, ProtobufProxy.OUTPUT_PATH.get());
    ...
    public com.baidu.bjf.remoting.protobuf.descriptor.FileDescriptorProtoPOJO decode(byte[] bb) throws IOException {
        ...
        com.baidu.bjf.remoting.protobuf.descriptor.FileDescriptorProtoPOJO ret = new com.baidu.bjf.remoting.protobuf.descriptor.FileDescriptorProtoPOJO();
        try {
            boolean done = false;
            Codec codec = null;
            while (!done) {
                ...
                if (tag == 34) {
                    codec = ProtobufProxy.create(com.baidu.bjf.remoting.protobuf.descriptor.DescriptorProtoPOJO.class, false, ProtobufProxy.OUTPUT_PATH.get());
                ...
                if (tag == 42) {
                    codec = ProtobufProxy.create(com.baidu.bjf.remoting.protobuf.descriptor.EnumDescriptorProtoPOJO.class, false, ProtobufProxy.OUTPUT_PATH.get());
                    int length = input.readRawVarint32();
                    final int oldLimit = input.pushLimit(length);
                ...
                if (tag == 50) {
                    codec = ProtobufProxy.create(com.baidu.bjf.remoting.protobuf.descriptor.ServiceDescriptorProtoPOJO.class, false, ProtobufProxy.OUTPUT_PATH.get());
                    int length = input.readRawVarint32();
                    final int oldLimit = input.pushLimit(length);
                ...
                if (tag == 58) {
                    codec = ProtobufProxy.create(com.baidu.bjf.remoting.protobuf.descriptor.FieldDescriptorProtoPOJO.class, false, ProtobufProxy.OUTPUT_PATH.get());
                    int length = input.readRawVarint32();
                    final int oldLimit = input.pushLimit(length);
                ...
                if (tag == 66) {
                    codec = ProtobufProxy.create(com.baidu.bjf.remoting.protobuf.descriptor.FileOptionsPOJO.class, false, ProtobufProxy.OUTPUT_PATH.get());
                    int length = input.readRawVarint32();
                    final int oldLimit = input.pushLimit(length);
                ...
                if (tag == 74) {
                    codec = ProtobufProxy.create(com.baidu.bjf.remoting.protobuf.descriptor.SourceCodeInfoPOJO.class, false, ProtobufProxy.OUTPUT_PATH.get());
                    int length = input.readRawVarint32();
                    final int oldLimit = input.pushLimit(length);
    ...
    public void writeTo(com.baidu.bjf.remoting.protobuf.descriptor.FileDescriptorProtoPOJO t, CodedOutputStream output) throws IOException {
        ...
        if (f_3 != null) {
            CodedConstant.writeToList(output, 3, FieldType.STRING, f_3);
        }
        if (f_4 != null) {
            CodedConstant.writeToList(output, 4, FieldType.OBJECT, f_4);
        }
        if (f_5 != null) {
            CodedConstant.writeToList(output, 5, FieldType.OBJECT, f_5);
        }
        if (f_6 != null) {
            CodedConstant.writeToList(output, 6, FieldType.OBJECT, f_6);
        }
        if (f_7 != null) {
            CodedConstant.writeToList(output, 7, FieldType.OBJECT, f_7);
        }
        if (f_8 != null) {
            CodedConstant.writeObject(output, 8, FieldType.OBJECT, f_8, false);
        }
        if (f_9 != null) {
            CodedConstant.writeObject(output, 9, FieldType.OBJECT, f_9, false);
        }
        if (f_10 != null) {
            CodedConstant.writeToList(output, 10, FieldType.INT32, f_10);
        }
        if (f_11 != null) {
            CodedConstant.writeToList(output, 11, FieldType.INT32, f_11);
        }
    }
